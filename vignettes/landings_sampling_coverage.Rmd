---
title: "Landings Sampling Coverage"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Landings Sampling Coverage}
...
The aim of this document is to provide examples of the different plots that can be produced using the coverageLandings() function.
...
```{r,warning=FALSE,message=FALSE}
  ...
  myPlots <- coverageLandingsBySpecies(
